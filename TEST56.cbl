      ...
      *    ***  苗字データ フリガナセット後
       ...
       01  WORK-AREA.
           03  WK-PGM-NAME     PIC  X(008) VALUE "TEST56  ".

      *     03  WK-PIN1-F-NAME  PIC  X(032) VALUE "TEST56.PIN1".
       ...
       S020-10.
           ...
           IF      WK-PIN1-STATUS =    ZERO
                   ...
                   UNSTRING PIN1-REC
                           DELIMITED BY X"09"
                           INTO
                           WK-P1-I1    COUNT WK-P1-I1-LEN
                           WK-P1-I2    COUNT WK-P1-I2-LEN
                           WK-P1-I3    COUNT WK-P1-I3-LEN

                   IF      WK-P1-I2    =      ZERO
                           MOVE    1           TO     WK-P1-I2-LEN
                           MOVE    SPACE       TO     WK-P1-I2
                   END-IF
      ...
      *    *** 名前（ひらがな）有
           IF      WK-P1-I2    NOT =   SPACE
                   MOVE    WK-P1-I2-LEN TO     WK-FURIGANA-LEN
                   MOVE    WK-P1-I2    TO      WK-FURIGANA
      ...
      *    *** POT1-REC SET SW-SET=Y
       S120-10.
           ...
           MOVE    1           TO      J3
      *    *** 名前（漢字）
           MOVE    WK-P1-I1-LEN TO     L
           MOVE    WK-P1-I1 (1:L) TO   POT1-REC (J3:L)
           ADD     L           TO      J3
           MOVE    ","         TO      POT1-REC (J3:1)
           ADD     1           TO      J3

      *    *** 誕生日　を先にする
           MOVE    WK-P1-I3-LEN TO     L
           MOVE    WK-P1-I3 (1:L) TO   POT1-REC (J3:L)
           ADD     L           TO      J3
           MOVE    ","         TO      POT1-REC (J3:1)
           ADD     1           TO      J3
      ...
      *    *** 名前（ひらがな）
           IF      WK-P1-I2    =       SPACE
                   ...
                   ADD     L           TO      J3
           ELSE
                   MOVE    WK-P1-I2-LEN TO     L
                   MOVE    WK-P1-I2 (1:L) TO   POT1-REC (J3:L)
                   ADD     L           TO      J3
           END-IF
           MOVE    ","         TO      POT1-REC (J3:1)
           ADD     1           TO      J3
           ...
           ELSE
                   MOVE    WK-P1-I3    TO      TBL04-FURIGANA(TBL04-IDX)
                   MOVE    POT1-REC    TO      TBL04-REC (TBL04-IDX)
      ...
      *    *** （名前順）,
           ...
           ELSE
      *    *** （誕生日順）,
                   MOVE    X"EFBC88E8AA95E7949FE697A5E9A086EFBC892C"
                                       TO      WK-TITLE (43:19)
           END-IF
