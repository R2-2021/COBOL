      ...
      *    *** C:TVConnectSuite => L:TVConnectSuite\201406 <=該当の所に移動
      *    *** smedio 見たいとき、TEST136.POT1 の情報から
      *    *** L:TVConnectSuite\YYYYMM => C:TVConnectSuite
      *    *** へ該当タイトル移動後、SMEDIO の
      *    *** 
      *    *** >L:
      *    *** >CD TVConnectSuite
      ...
      *    *** INFO 解析データ　ファイル名、タイトル、作成日
       ...
       01  WORK-AREA.
           ...
           03  WK-PIN1-F-NAME  PIC  X(032) VALUE "TEST136.PIN1".
           03  WK-PIN2-F-NAME.
             05                PIC  X(018) VALUE "C:\TVConnectSuite\".
      *       05  WK-PIN2-F-YYYYMM
      *                         PIC  X(006) VALUE SPACE.
             05                PIC  X(001) VALUE "\".
             05  WK-PIN2-F-NAME2
                               PIC  X(050) VALUE "XXX.info".
           03  WK-POT1-F-NAME  PIC  X(032) VALUE "TEST136.POT1".
