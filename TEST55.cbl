      ...
      *    *** 芸能人（名前順＿
             05                PIC  X(024) VALUE
               X"E88AB8E883BDE4BABAEFBC88E5908DE5898DE9A086EFBCBF".
             05                PIC  X(020) VALUE SPACE.
             05  WK-GEINOU-YYYY PIC 9(004) VALUE ZERO.
      *    *** 年12月31日現在,
             05                PIC  X(020) VALUE 
      ...
      *             MOVE    PIN1-REC    TO      WK-TITLE
                   ...
                   MOVE    WDT-DATE-YYYY TO     WK-GEINOU-YYYY
                   MOVE    WK-GEINOU    TO      WK-TITLE
                   IF      SW-SEX      =       "A"
                           MOVE    
      *    *** 女性・男性）
                           X"E5A5B3E680A7E383BBE794B7E680A7EFBC89"
                                       TO      WK-TITLE (27:18)
                   ELSE
                       IF      SW-SEX      =       "W"
                           MOVE    
      *    *** 女性）
                           X"E5A5B3E680A7EFBC89"
                                       TO      WK-TITLE (27:9)
                       ELSE
                           MOVE
      *    *** 男性）
                           X"E794B7E680A7EFBC89"
                                       TO      WK-TITLE (27:9)
                       END-IF
                   END-IF
                   EXIT    PARAGRAPH
