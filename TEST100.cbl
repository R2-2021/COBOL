      ...
      *    *** Directory of,File(s)  WIN10 データ
       SELECT PIN1-F           ASSIGN   WK-PIN1-F-NAME
                               STATUS   WK-PIN1-STATUS
           ORGANIZATION LINE   SEQUENTIAL.

      *    *** Directory of,File(s)  WIN11 データ
      ...
      *    *** データ
       ...
       01  WORK-AREA.
           03  WK-PGM-NAME     PIC  X(008) VALUE "TEST100 ".

           03  WK-PIN1-F-NAME  PIC  X(032) VALUE
               "TEST99_WIN10.POT1".
           03  WK-PIN2-F-NAME  PIC  X(032) VALUE
               "TEST99_WIN11.POT1".
           03  WK-POT1-F-NAME  PIC  X(032) VALUE "TEST100.POT1".
           03  WK-POT2-F-NAME  PIC  X(032) VALUE "TEST100.POT2".
