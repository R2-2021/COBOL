      ...
      *    *** årê¸ògÉZÉbÉgÅAÇ`ÇSècÅAÇ`ÇSâ°  ÉvÉçÉOÉâÉÄÇ≈ê›íË
      ...
      *         "TEST28_201110_2018XX.CSV".
           ...
           03  WK-TIT1.
             ...
             05                PIC  X(020) VALUE "ÉAÉjÉÅÉ^ÉCÉgÉãàÍóóï\".
             05                PIC  X(002) VALUE SPACE.
             05                PIC  X(006) VALUE "ÅñÅñÅñ".
      ...
      *    *** àÛç¸ÉyÅ[ÉWê›íË
      *    *** îºäpÉtÉHÉìÉg  ÇlÇrÉSÉVÉbÉN
      *    *** ëSäpÉtÉHÉìÉg  ÇlÇrÉSÉVÉbÉN
      *    *** ÉtÉHÉìÉgçÇ  ÇQÇVÇçÇçÅAÇVÅDÇUÇêÇî
      *    *** çsëóÇËÇOÅì
      *    *** ó]îí  è„ÇPÇOÅAâ∫ÇPÇOÅAâEÇPÇOÅAç∂ÇPÇOÇçÇç
      *    *** 
      ...
      *    *** âÊñ çÄñ⁄
           ...
           03  WK-KEI1-A4T.
             ...
             05                PIC  X(004) VALUE ALL "Ñü"
             05                PIC  X(002) VALUE "Ñ¶"
             05                PIC  X(002) VALUE ALL "Ñü"
             05                PIC  X(002) VALUE "Ñ¶"
             05                PIC  X(022) VALUE ALL "Ñü"
             05                PIC  X(002) VALUE "Ñ¢"
      ...
      *    *** P1-PX ÇÃàÛéöçáåvåÖêî  ÉXÉyÅ[ÉXä‹Çﬁ
      ...
      *    *** WK-REMAINDER ècÅAâ°Ç«ÇøÇÁÇ‡ÅAÉ[ÉçÇ»ÇÃÇ≈ÅAñ¢égópÇ∆Ç∑ÇÈ
           IF      SW-A4TATE   =       "1"
      ...
      *    *** ÉeÅ[ÉuÉãÅi2Åjà»ç~  êÇíºê¸ÅAíuÇ´ä∑Ç¶ÇÈ
      ...
      *    *** CLOSE
       S900-10.
           ...
           DISPLAY WK-PGM-NAME " POT1 ï≈   = " WK-PAGE-E
                   " (" WK-POT1-F-NAME ")"
