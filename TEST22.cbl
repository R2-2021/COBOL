      *    *** INDEX FILE SEQ èoóÕ
       ...
       FD  POT1-F
           LABEL RECORDS ARE STANDARD.
       01  POT1-REC.
      *     03  POT1-KEY        PIC  9(010).
      *     03  POT1-DATA       PIC  X(070).
           03  POT1-KEY        PIC  9(006).
           03  POT1-NO         PIC  9(004).
           03  POT1-DATA       PIC  X(1000).

       WORKING-STORAGE         SECTION.
       01  WORK-AREA.
           03  WK-PGM-NAME     PIC  X(008) VALUE "TEST22  ".

           03  WK-PIN1-F-NAME  PIC  X(032) VALUE "expo_jam_2018.csv".
      *     03  WK-PIN1-F-NAME  PIC  X(032) VALUE "TEST32.POT1".
      *     03  WK-POT1-F-NAME  PIC  X(032) VALUE "TEST22.POT1".
           03  WK-POT1-F-NAME  PIC  X(032) VALUE "TEST104.PIO1".
      ...
      *                                 PIN1-REC
           ...
           MOVE    WK-PIN1-CNT TO  POT1-KEY
           MOVE    PIN1-REC TO     POT1-DATA
      ...
      *
           ...
           ELSE
               IF      WK-POT1-STATUS =    21 
      *             CONTINUE
                   DISPLAY WK-PGM-NAME " POT1-F KEY INVALID KEY=" 
                           POT1-KEY
               ELSE
