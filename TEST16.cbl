      ...
      *    *** SJIS 漢字データ
       ...
       01  WORK-AREA.
           ...
           03  WK-PGM-NAME     PIC  X(008) VALUE "TEST16  ".

           03  WK-PIN1-F-NAME  PIC  X(011) VALUE "TEST16.PIN1".
           03  WK-POT1-F-NAME  PIC  X(011) VALUE "TEST16.POT1".
      ...
      *      05  FILLER        PIC  X(010) VALUE SPACE.
             05  FILLER        PIC  X(050) VALUE "TEST16".
      ...
      *    *** 29*7=133 
           03  WK-MID1         PIC  X(203) VALUE ALL "コード ".
           03  WK-HAI          PIC  X(203) VALUE ALL "------ ".
