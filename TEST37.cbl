      ...
      *    *** INDEX FILE
           ...
           03  WK-TIT1-A4T.
             05                PIC  X(040) VALUE "TEST37-T".
             05  WK-TIT1-A4T-1 PIC  X(076) VALUE SPACE.

           03  WK-TIT1-A4Y.
             05                PIC  X(070) VALUE "TEST37-Y".
      ...
      *    *** SW-内容はTEST37.PRM1 よりセットする
       01  SW-AREA.

      *    *** "1" = A4縦,
      *    *** "0" = A4横
           03  SW-A4TATE       PIC  X(001) VALUE "X".

      *    *** "0" = 明細無し
      *    *** "1" = 明細出力
           03  SW-MEISAI       PIC  X(001) VALUE "X".

      *    *** 明細改行数、明細無しの時、”１”の方が良い
      *    *** "1" = 1行　改行
      *    *** "2" = 2行　改行
           03  SW-KAIGYO       PIC  X(001) VALUE "X".

      *    *** "0" = ブレイク時の改行無し
      *    *** "1" = ブレイク時の改行有り
           03  SW-KAIGYO-BR    PIC  X(001) VALUE "X".
      ...
      *    *** OPEN
       S010-10.
           ...
           READ    PRM1-F
               AT END
                   DISPLAY WK-PGM-NAME " PRM1-F READ ZERO件 ERROR"
                   STOP    RUN
               NOT AT END
                   CONTINUE
           END-READ
