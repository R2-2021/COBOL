      *    *** MissAVóp TEST103.ÇlÇâÇìÇìÇ`ÇuÅ@ÇwÇwÇwÇw.PIN1
      *    *** ìØàÍÇhÇcÇÕñ≥èCê≥ÇêÊÇ…èoóÕ
      *    *** 
      ...
      *    *** TEST103.ÇlÇâÇìÇìÇ`ÇuÅ@ÇwÇwÇwÇw.PIN1
      ...
      *    *** TEST104 PIN2 ÉfÅ[É^
       ...
       01  WORK-AREA.
           ...
           03  WK-POT1-F-NAME  PIC  X(032) VALUE "TEST134.POT1".
