      ...
      *    *** HTML データ
       ...
       01  WORK-AREA.
           03  WK-PGM-NAME     PIC  X(008) VALUE "TEST50  ".
      ...
      *         "TEST50.PIN1".
           ...
           03  WK-PIN2-F-NAME  PIC  X(032) VALUE "TEST50.PIN2".
      ...
      *    *** YouTube アニメ年代順
           03  WK-TITLE-ANIME.
             ...
             05                PIC  X(009) VALUE X"E5B9B4E4BBA3E9A086".

           03  WK-TITLE2       PIC  X(256) VALUE SPACE.
           03  WK-SITE1        PIC  X(256) VALUE SPACE.
           ...
           03  WK-PREV-X.
             05  WK-PREV       PIC  9(003) VALUE ZERO.
           03  WK-NEXT-X.
             05  WK-NEXT       PIC  9(003) VALUE ZERO.
      ...
      *    *** netflix
           MOVE    "<a href='https://www.netflix.com/search?q="
                               TO      POT1-REC
           WRITE   POT1-REC
           ADD     1           TO      WK-POT1-CNT
      ...
      *    *** #NNN
           ...
           EVALUATE TRUE
      *    *** MM ?
               WHEN PIN1-REC (19:2) = "01"
                   MOVE    '">'
                                   TO      POT1-REC
               WHEN PIN1-REC (19:2) = "04"
                   MOVE    '" style="position:relative; left:32px;">'
                                   TO      POT1-REC
               WHEN PIN1-REC (19:2) = "07"
      ...
      *                             TO      POT1-REC
      *           ELSE
      *             MOVE    '" style="position:relative; left:96px;">'
      *                             TO      POT1-REC
      *           END-IF
                   MOVE    '" style="position:relative; left:96px;">'
                                   TO      POT1-REC
      ...
      *    *** MM=?
           ...
           ELSE
                   MOVE    '</a>'      TO      POT1-REC
           END-IF
           MOVE    PIN1-REC (9:4) TO   WK-OLD-YYYY
           WRITE   POT1-REC
           ADD     1           TO      WK-POT1-CNT
