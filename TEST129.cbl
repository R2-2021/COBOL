      ...
      *    *** 抽出データ
       ...
       01  WORK-AREA.
           03  WK-PGM-NAME     PIC  X(008) VALUE "TEST129 ".

      *     03  WK-PIN1-F-NAME  PIC  X(032) VALUE "TEST129.PIN1".
           03  WK-PIN1-F-NAME  PIC  X(032) VALUE
               "TEST53_world_ichiran.PIN1".

           03  WK-POT1-F-NAME  PIC  X(032) VALUE "TEST129.POT1".
      *         "TEST53_world_ichiran.PIN0".
       ...
       S020-10.
           ...
           READ    PIN1-F
               ...
               NOT AT END
                   ...
                   MOVE    " , ,"      TO   PIN1-REC (WK-PIN1-LEN + 1:4)
                   UNSTRING PIN1-REC
      *                     DELIMITED BY ","
                           DELIMITED BY " ,"
                           INTO
      ...
      *             COMPUTE WK-ITEM3-LEN = 
      *                     WK-PIN1-LEN - 5 - WK-ITEM2-LEN
           END-READ
           .
       S020-EX.
           EXIT.
      ...
      *    *** WRITE POT1
       S110-10.
           ...
           MOVE    "https://i.ytimg.com/vi//hqdefault.jpg ," TO
                   POT1-REC (L1:39)
           ADD     39          TO      L1

           MOVE    "https://www.youtube.com/watch?v= ! ," TO
                   POT1-REC (L1:36)
           ADD     36          TO      L1
           WRITE   POT1-REC
           ADD     1           TO      WK-POT1-CNT
